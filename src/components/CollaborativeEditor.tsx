...
function EditorSurface({
  ...
  // Initial stats calculation once mounted
  useEffect(() => {
    if (editor) {
        ...
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-xs hover:from-blue-700 hover:to-indigo-700 transition"
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold border shadow-xs transition ${
                isSimulatingOffline
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold border border-slate-300 bg-white hover:bg-slate-50 text-slate-700 shadow-xs transition"
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium border border-slate-300 bg-white hover:bg-slate-50 shadow-xs transition"
            >
              <span
            ...
            <button
              ...
              className={`p-1.5 rounded-lg border transition ${showSidebar ? 'bg-blue-50 border-blue-200 text-blue-600' : 'bg-white border-slate-300 text-slate-600 hover:bg-slate-50'}`}
        ...
        <div className="bg-amber-500 text-white px-4 py-2 text-xs font-medium flex items-center justify-between shadow-xs">
          ...
          {isSimulatingOffline && (
            <button
              type="button"
              onClick={toggleNetworkSimulation}
              className="px-3 py-0.5 bg-white text-amber-800 rounded font-semibold text-xs shadow-xs hover:bg-amber-50"
            >
              Reconnect
            </button>
          )}
        ...
        <div className="bg-white border-b border-slate-200 px-6 py-3 flex flex-wrap items-center justify-between gap-4 text-xs shadow-sm animate-in fade-in">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="ml-3 px-2.5 py-1 rounded bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold"
            >
              Done
            </button>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl border border-slate-200 max-w-lg w-full p-6 animate-in fade-in zoom-in-95">
            ...
            <div className="mt-6 flex justify-end gap-2">
              <button
                type="button"
                onClick={copyShareUrl}
                className="px-3.5 py-1.5 rounded-lg border border-slate-300 text-slate-700 hover:bg-slate-50 font-semibold text-xs transition"
              >
